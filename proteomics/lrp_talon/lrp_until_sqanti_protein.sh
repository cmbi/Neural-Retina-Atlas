...
talon_gtf=/mnt/xomics/tabear/atlas_paper/transcriptome/talon/venice_fl2_talon
talon_classification=/mnt/xomics/tabear/atlas_paper/transcriptome/talon/venice_talon_abundance_filtered.tsv
...
genome=/mnt/xomics/tabear/ref_genome/GRCh38/hg38.fa 
...
# python ${script_folder}/0_add_fl_to_talon/add_fl_to_talon.py \

...
#%%
def collapse_isoforms(gff_filename, fasta_filename, name, out_dir):
    ...
    good = []
    output_gtf_filename = f'{out_dir}/{name}_corrected.5degfilter.gff'
    ...
    SeqIO.write(isoform_seqs, f'{out_dir}/{name}_corrected.5degfilter.fasta','fasta')
...
def main():
    ...
    collapse_isoforms(args.sqanti_gtf,args.sqanti_fasta, args.name, args.out_dir)

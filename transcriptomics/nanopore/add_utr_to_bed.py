...
combined[['chrom', 'chromStart', 'chromEnd', 'name_orf', 'score', 'strand', 'thickStart_orf', 'thickEnd_orf', 'itemRgb', 'blockCount', 'blockSizes', 'blockStarts']].to_csv("../../data/transcriptomics/nanopore/transcripts_and_orfs.bed",sep='\t',header=False,index=False)